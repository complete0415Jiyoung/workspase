...
--user01의 비밀번호 변경
UPDATE  "MEMBER" SET
MEMBER_PW= '$2a$10$WqFSjctwQEdwLBKbbXCM2O80NEc2BWT4FG26ypdZI5/iMiCP3Ydm2';
...
SELECT  MEMBER_NO, MEMBER_EMAIL, MEMBER_NICKNAME, MEMBER_TEL ,
    ...
    TO_CHAR(ENROLL_DATE,'YYYY"년" MM"분" DD"일" HH24"시" MI"분" SS"초" ') AS ENROLL_DATE
FROM MEMBER
...
INSERT INTO "COMMENT"                                     -- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글2-1-1', DEFAULT, DEFAULT, 1506, 1, 1028);
