...
public class JDBCTemplate {
	...
	// 필드
	private static Connection conn;  //초기 값 null
	//private static Connection conn = null; //초기 값 null
	...
	public static Connection getConnection() {
		...
		try {
			...
			if(conn == null || conn.isClosed()) {
				...
				// K,V 가 모두 String 인 map,XML 파일 입출력에 특화 
	...
	//Statement(부모) preperedStatement(자식) 반환 메소드(다향성 적용)
	public static void close(Statement stmt) {
		try {
			//참조하는 Statement이 있으면서 닫혀 있지 않은 경우 
