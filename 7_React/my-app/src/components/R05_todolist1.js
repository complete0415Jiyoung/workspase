import React, { useState } from 'react'; //imrs + Enter
...
const InputName =() => {
    ...
    // useState(''): name 변수에 대입되는 초기 값을 ''(빈칸으로 출력)
            ...
            */}
            <ul>
                {todos.map( ( todo, index ) => {
                    return(
                        /* key 속성 : 배열 (list) 출력시 요소를 구분라는 key값 */ 
                        <li key={index}>
                            <input type='checkbox'
...
// 외부에서 해당파일 import시 todoList1을 내보내는 것을 기본 값
